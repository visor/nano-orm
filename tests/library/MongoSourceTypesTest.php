 ...
 * @group orm
 */
class MongoSourceTypesTest extends \Nano\TestUtils\TestCase {
	...
	public function getSourceTypes() {
		include_once $this->files->get($this, '/model/AddressMongo.php');
		$source =  new \Module\Orm\DataSource\Mongo(array(
			'server'     => 'localhost'
			, 'database' => 'nano_test'
		));
		$result = array();
	...
	public function testCastingMongoIdFields() {
		...
		$this->castingMondoFieldType('MongoId', $sourceValue, $modelValue, 'identity');
	}

	public function testCastingMongoDateFields() {
		$modelValue  = \Nano\Util\Date::create('2010-10-10 12:00:00');
